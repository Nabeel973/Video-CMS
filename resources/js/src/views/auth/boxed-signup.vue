                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">Create your account</p>
                        </div>
                        <form class="space-y-5 dark:text-white" @submit.prevent="handleSubmit">
                            ...
                            <div v-if="successMessage" class="mb-4 p-3 rounded bg-green-100 text-green-500 dark:bg-green-900/30">
                                {{ successMessage }}
                            </div>
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    ...
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path
                                                opacity="0.5"
                                                d="M9 2.25C9.41421 2.25 9.75 2.58579 9.75 3V3.75H14.25C14.6642 3.75 15 4.08579 15 4.5C15 4.91421 14.6642 5.25 14.25 5.25H9.75V15C9.75 15.4142 9.41421 15.75 9 15.75C8.58579 15.75 8.25 15.4142 8.25 15V5.25H3.75C3.33579 5.25 3 4.91421 3 4.5C3 4.08579 3.33579 3.75 3.75 3.75H8.25V3C8.25 2.58579 8.58579 2.25 9 2.25Z"
                                                fill="currentColor"
                                            />
                                        </svg>
                                    </span>
                            ...
                            <div>
                                ...
                                <div v-if="formErrors.password_confirmation" class="mt-1 text-sm text-red-500">
    ...
    if (result.success) {
        ...
        if (result.validationErrors) {
            if (result.validationErrors.name) {
                formErrors.name = result.validationErrors.name[0];
            }
            ...
            if (result.validationErrors.password_confirmation) {
                formErrors.password_confirmation = result.validationErrors.password_confirmation[0];
            }
        }
    }
